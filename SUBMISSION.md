...
**What we inherited**
<!-- CopilotKit Agents Everywhere starter kit (agent-core, CopilotKit React runtime, Ambiguous HITL write adapter, sponsor docs). Impeccable design skill. -->

**What we built during the hackathon**
<!-- Tabme: Chrome tab capture, review sessions, suggestion heuristics, Approve selected, extension. Running the supplied incident demo alone does not establish a new project. -->
