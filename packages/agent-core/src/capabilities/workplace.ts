 ...
 *
 *   npx ambiguous auth signup --name "Tabme" --human-email you@example.com
 *
...
export const WORKPLACE_CONTEXT =
  "You have an Ambiguous AI workspace available over MCP: mail, tasks, CRM, docs, sheets, calendar and drive. Use it to make approved Tabme suggestions real — file the task, save the note — instead of telling someone else to do it. It is still a write to a shared system, so the approval rule applies.";
